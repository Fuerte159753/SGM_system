...
import { emailDomainValidator } from '../../administrador/tecnicoslist/custom-validators';

@Component({
  selector: 'app-perfiltec',
  standalone: true,
  imports: [FormsModule, ReactiveFormsModule, NgIf],
  templateUrl: './perfiltec.component.html',
  styleUrl: './perfiltec.component.css'
})
export class PerfiltecComponent implements OnInit {
  id: any = '';
  adminPerfil: any = {};
  ...
  constructor(private service: TecnicoService, private fb: FormBuilder, private rote: Router) {
